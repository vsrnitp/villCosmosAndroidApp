...
import {
  ...
  const URL = `https://villCosmos.vsrnitp.repl.co/api/vegetable`;

  class ConfirmVegetableOrder extends Component{
      state={
      ...
      placeOrder = (itemName,itemPrice,quantity,address,mobileNo,totalBill) => {
         ...
         var confirmation = null;
          confirmation = axios.post(`${URL}/orderPlace/vegetableConfirm`,{
      ...
      return(
          <ScrollView style={{backgroundColor:'black'}}>
            <View style={{flex:1,alignItems:'center',justifyContent:'center',marginBottom:20}}>
               ...
               <MaterialCommunityIcons name="fruit-watermelon" size={50} color={'green'} style={{paddingBottom:10}}/>
               {/* Confirm order */}
  ...
  export default ConfirmVegetableOrder;